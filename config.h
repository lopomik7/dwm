//Treesitter bug put this :set filetype=c
...
static char *fonts[] = { "FiraCodeNerdFontMono-Medium.ttf:size=11", "NotoColorEmoji:pixelsize=10:antialias=true:autohint=true" };
...
static const unsigned int baralpha = 190;    // Fully transparent status bar
static const unsigned int borderalpha = 140; // Fully transparent window borders
...
/*static const char *tags[] = { ">_", "🌍", "📂", "💻", "📝", "🖼️", "🖌️", "🎲", "🗑️" };*/
...
/* static int enablegaps  = 1;    /1* 1 means enable gaps on startup *1/ */
...
static const Key keys[] = {
    ...
    { MODKEY,                       XK_c,          spawn,                  {.v = (const char*[]){ "rofi", "-show", "window", NULL } } },
    { MODKEY|ShiftMask,             XK_c,          spawn,                  {.v = (const char*[]){ TERMINAL, "-e", "calcurse", NULL } } },
    { MODKEY,                       XK_section,    spawn,                  {.v = (const char*[]){ TERMINAL, "-e", "tmux", "new-session", "-A", "-s", "home", "nvim", ".", NULL } } },
    /* V is automatically bound above in STACKKEYS */
    { MODKEY,                       XK_b,          togglebar,              {0} },
    { MODKEY|ShiftMask,             XK_b,          spawn,                  {.v = (const char*[]){ TERMINAL, "-e", "sh", "-c", "zathura \"$HOME/Downloads/cheat/cheatcombined.pdf\"", NULL } } },
    ...
    { MODKEY,                       XK_F1,         spawn,                  {.v = (const char*[]){ "zdmvim", NULL } } },
    { MODKEY,                       XK_F2,         spawn,                  {.v = (const char*[]){ "ytfuzz", NULL } } },
